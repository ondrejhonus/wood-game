...
Místo toho, aby každý strom ve scéně sám kontroloval svou vzdálenost od hráče (což by znamenalo tisíce volání metody \texttt{Update} v každém snímku), jsem zvolil architekturu **centrálního manažera**.
